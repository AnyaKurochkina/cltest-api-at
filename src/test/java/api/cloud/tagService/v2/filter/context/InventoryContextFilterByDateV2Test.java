...
public class InventoryContextFilterByDateV2Test extends AbstractTagServiceTest {

    //GTE(">="), GT(">"), LT("<"), LTE("<=");
    @Test
    @TmsLink("1623725")
    @DisplayName("Inventory. Контекстный фильтр V2. created_at = lt & gte")
    void findInventoriesByCreatedAtLtAndGte() {
        ...
        FilterResultV2Page findInventories = TagServiceSteps.inventoryFilterV2(context, filter);
    ...
    @Test
    @TmsLink("1623739")
    @DisplayName("Inventory. Контекстный фильтр V2. created_at = lte & gt")
    ...
    @Test
    @TmsLink("1623741")
    @DisplayName("Inventory. Контекстный фильтр V2. updated_at = lt & gte")
    ...
    @Test
    @TmsLink("1623742")
    @DisplayName("Inventory. Контекстный фильтр V2. updated_at = lte & gt")
