...
public class BillExcelReader extends AbstractExcelReader<BillExcel> {

    private static final AbstractExcelSheet<BillExcel> READER_SHEET = new BillExcelSheet();
    ...
    public List<BillExcel> read() {
        //Пропускаем первые 4 строки потомучто они бесполезны для конкретного xlsx файла
