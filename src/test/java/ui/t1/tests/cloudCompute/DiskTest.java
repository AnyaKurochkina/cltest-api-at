...
public class DiskTest extends AbstractComputeTest {
    ...
    void diskList() {
        ...
        Assertions.assertEquals(Arrays.asList("", "Имя", "Зона доступности", "Размер, ГБ", "Виртуальная машина", "Дата создания", "Тип", "Системный", ""),
                new DiskList.DiskTable().getHeaders(), "Названия столбцов в таблице не совпадают");
    }
    ...
    @Test
    @TmsLink("1249423")
    @DisplayName("Cloud Compute. Диски. Создать образ")
