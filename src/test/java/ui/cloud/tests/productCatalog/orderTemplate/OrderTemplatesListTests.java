...
public class OrderTemplatesListTests extends OrderTemplateBaseTest {
    ...
    public void addAndDeleteTagFromList() {
        ...
        new ControlPanelIndexPage()
                ...
                .addTag(tag1)
                .closeDialog()
                .checkTags(ORDER_TEMPLATE_NAME_COLUMN, orderTemplate.getName(), tag1.substring(0, 6))
                .checkTags(ORDER_TEMPLATE_NAME_COLUMN, orderTemplate2.getName(), tag1.substring(0, 6))
                .editTags()
                .removeTag(tag1)
                .closeDialog()
