...
public class UiWindowsTest{
    ...
    void orderWindows(Windows product) {
        new LoginPage(product.getProjectId())
                .singIn();
        open("https://cloud.vtb.ru/vm/orders?page=0&perPage=10&f[category]=vm&f[status][]=success&f[status][]=changing&f[status][]=damaged&f[status][]=pending&context=proj-frybyv41jh&type=project&org=vtb");
        new ProductsPage();
