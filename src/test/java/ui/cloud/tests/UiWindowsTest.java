...
public class UiWindowsTest extends Tests {
    ...
    public UiWindowsTest() {
        if (Configure.ENV.equals("prod"))
           // product = product.buildFromLink("https://prod-portal-front.cloud.vtb.ru/vm/orders/30d227af-278f-4e1e-a90d-b5bec15630c5/main?context=proj-frybyv41jh&type=project&org=vtb");
...
//        prepriceOrderDbl = iProductPage.prePriceOrder(iProductPage.getOrderPricePerDay().getAttribute("textContent"));
...
//
    ...
    @TmsLink("")
    @Order(11)
    @DisplayName("UI Windows. Получение текущей стоимости продукта")
    void checkHistoryGraphScheme() {
        new IndexPage().getBtnProducts().click();
        new ProductsPage()
                .getRowByColumn("Продукт",
...
//    @TmsLink("")
//    @Order(12)
//    @DisplayName("UI Windows. Проверка, что стоимость продукта соответствует предбиллингу.")
//    @SneakyThrows
//    void checkHistoryRowDeployErr() {
//        new IndexPage().getBtnProducts().click();
//        new ProductsPage()
...
//    @TmsLink("")
//    @Order(12)
//    @DisplayName("UI Windows. Проверка наличия на странице текста \"Просмотр схемы выполнения\".")
//    void checkHistoryRowDeployErr() {
//        new IndexPage().getBtnProducts().click();
//        new ProductsPage()
//                .getRowByColumn("Продукт",
