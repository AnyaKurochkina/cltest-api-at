...
public class UiPostgreSqlClusterAstraLinuxTest extends UiProductTest {
    ...
    PostgresSQLCluster product = PostgresSQLCluster.builder().build().buildFromLink("https://console.blue.cloud.vtb.ru/db/orders/8de1cb80-e019-468f-87fa-0b637b5587fd/main?context=proj-iv550odo9a&type=project&org=vtb");
    String nameDb = "at_db";
...
//    }
    ...
    void addGroupAccess() {
        PostgreSqlClusterAstraPage pSqlPage = new PostgreSqlClusterAstraPage(product);
        pSqlPage.runActionWithCheckCost(CompareType.EQUALS, () -> pSqlPage.addGroupAccess(new Table("Роли узла").getRowByIndex(0)));
    }
