...
public class UiPodmanTest extends UiProductTest {
    ...
    Podman product;
    //= Podman.builder().build().buildFromLink("https://ift2-portal-front.apps.sk5-soul01.corp.dev.vtb/containers/orders/0005864c-61aa-4596-b947-db513c049085/main?context=proj-pkvckn08w9&type=project&org=vtb");
