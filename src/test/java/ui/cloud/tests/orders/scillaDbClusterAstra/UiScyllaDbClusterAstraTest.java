...
public class UiScyllaDbClusterAstraTest extends UiProductTest{
    ...
    ScyllaDbCluster product=ScyllaDbCluster.builder().build().buildFromLink("https://console.blue.cloud.vtb.ru/db/orders/05fd34cd-6884-4001-b642-18fa95235120/main?context=proj-iv550odo9a&type=project&org=vtb");
    String nameDb = "at_db";
