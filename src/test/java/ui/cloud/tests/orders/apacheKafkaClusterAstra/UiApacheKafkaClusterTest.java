...
public class UiApacheKafkaClusterTest extends UiProductTest {
    ...
    ApacheKafkaCluster product=ApacheKafkaCluster.builder().build().buildFromLink("https://ift2-portal-front.apps.sk5-soul01.corp.dev.vtb/application_integration/orders/0d3fcdf7-2720-4ad9-8f7c-bff246345e35/main?context=proj-pkvckn08w9&type=project&org=vtb");
