...
public class UiApacheKafkaClusterTest extends UiProductTest {
    ...
    //=ApacheKafkaCluster.builder().build().buildFromLink("https://prod-portal-front.cloud.vtb.ru/application_integration/orders/25fec085-7636-4fd1-9280-151afe496e4e/main?context=proj-ln4zg69jek&type=project&org=vtb");
