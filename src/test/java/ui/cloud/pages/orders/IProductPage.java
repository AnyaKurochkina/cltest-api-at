...
public abstract class IProductPage {
    ...
    public void runActionWithCheckCost(CompareType type, Executable executable) {
        ...
        Waiting.find(() -> prebillingCostValue.equals(getOrderCost()), Duration.ofMinutes(11),
    ...
    public double getOrderCost() {
        double cost = OrderUtils.getCostValue(currentOrderCost.shouldBe(Condition.visible, Duration.ofMinutes(11)));
