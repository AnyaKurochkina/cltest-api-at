...
import httpModels.productCatalog.createTemplate.response.CreateTemplateResponse;
import httpModels.productCatalog.createTemplate.response.Input;
import httpModels.productCatalog.createTemplate.response.Output;
import httpModels.productCatalog.createTemplate.response.PrintedOutput;
